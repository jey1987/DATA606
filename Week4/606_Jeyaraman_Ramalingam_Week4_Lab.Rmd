...
-   Note that normal probability plots C and D have a slight stepwise pattern.  
    ...
    The values are fluctuating and they tend to be normal but step up and down from the normal line.
...
-   As you can see, normal probability plots can be used both to assess 
    ...
    The probability plot looks Right skewed as the tail is on the right side.
