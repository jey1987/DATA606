...
```{r binomial_Serves1, eval=TRUE}
total_serves = 10 -1
num_serves = 3 - 1
prob_serves = 0.15

number_of_serves <- factorial(total_serves)/(factorial(num_serves)*factorial(total_serves - num_serves))
probability_four_bin <- number_of_serves*(prob_serves^num_serves)*((1-prob_serves)^(total_serves-num_serves))
probability_four_bin
