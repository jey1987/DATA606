...
The mosaic plot tells us that man has smoked over 100 cigarattes more than woman.
...
```{r under23_Smoke, eval=TRUE}
under23_and_smoke <- subset(cdc,  age < 23)
```    
