...
-   Describe the distribution of streak lengths. What is the typical streak 
    ...
    Answer : The typical streak length is 1 for the independent shooter and the longest streak the independent shooter had is 5
...
-   If you were to run the simulation of the independent shooter a second time, 
    ...
    Answer : In the second run of simulation the distribution will be different comparing to the distribution created above. It will not be totally different but we can see the changes in several streak lengths.
...
-   How does Kobe Bryant's distribution of streak lengths compare to the 
    ...
    Answer : The distribution of simulated independent shooter is a little different from the Kobe Bryant's shooting distribution. Except for a streak length of zero and streak length of 5 the other values tend to fit the Kobe bryant's patterns. Since Independent shooter has more streak lengths we can come to the conclusion that Kobe is not having a hot hand. If he had hot hand the streak lengths would be increased and we would have seen the streak length of 5.
